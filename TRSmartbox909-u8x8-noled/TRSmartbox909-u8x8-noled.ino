...
void setup() {
  ...
  u8x8.drawString(u8x8colOne, 0, " thinkingRoad");
  u8x8.drawString(u8x8colOne, 1, " smartBox_909");
#endif
...
void loop() {
  ...
  setpointVal =  map(potValue, 0, 1023, 109, 909); // convert 0-1023 potValue to a setpointVal of 109-1075
  ...
  if (setpointVal > 909) setpointVal = 909; // chop that data value off at the knees
