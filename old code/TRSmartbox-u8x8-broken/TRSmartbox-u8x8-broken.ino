...
void setup() {
  ...
  u8x8.drawString(u8x8colOne - 1, 1, "Smart Box Alpha");
#endif
...
if (procVal >= 1000 ) u8x8.setCursor(u8x8colTwo-1, 5); //ceiling, max op 1200
  ...
  u8x8.setCursor(u8x8colOne, 7);
  if (procVal >= 109) u8x8.print("NAIL DANGEROUS");
  else u8x8.print("NAIL SAFE NOW");
